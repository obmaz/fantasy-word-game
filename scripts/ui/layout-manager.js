...
(function () {
    ...
    function loadRandomTitleHeader() {
        ...
        dlog('Loading random title header:', imagePath);
    ...
    window.loadRandomTitleHeader = loadRandomTitleHeader;
    window.syncTitleButtonOverlay = syncTitleButtonOverlay;
    window.syncGameScreenSizeToTitle = syncGameScreenSizeToTitle;
})();
